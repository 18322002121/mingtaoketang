...
@class PublicSegmentedControl;

typedef void (^IndexChangeBlock)(NSInteger index);
typedef NSAttributedString *(^HMTitleFormatterBlock)(PublicSegmentedControl *segmentedControl, NSString *title, NSUInteger index, BOOL selected);
...
@interface PublicSegmentedControl : UIControl
