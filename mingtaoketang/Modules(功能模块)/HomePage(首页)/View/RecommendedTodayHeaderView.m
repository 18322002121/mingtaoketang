...
- (PublicLabel *)titles{
    if (!_titles) {
        _titles = [PublicLabel labelWithText:@"今日推荐" textColor:[UIColor colorWithHexString:@"#333333"] font:BOLDSYSTEMFONT(22) textAlignment:NSTextAlignmentCenter backgroundColor:[UIColor clearColor]];
