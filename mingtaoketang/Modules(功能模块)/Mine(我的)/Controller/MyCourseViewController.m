...
static NSString *const myCourseViewCell =@"MyCourseViewCell";
...
- (PublicTableView *)tableView{
    if (!_tableView) {
        ...
        [_tableView registerClass:[MyCourseViewCell class] forCellReuseIdentifier:myCourseViewCell];
...
- (void)reloadTableviewDatasource:(PublicTableView *)tableviews{
    ...
    tableviews.cellForRowAtIndexPathBlock = ^UITableViewCell * _Nonnull(UITableView * _Nonnull tableView, NSIndexPath * _Nonnull indexPath) {
        ...
        MyCourseViewCell *cell =[tableView dequeueReusableCellWithIdentifier:myCourseViewCell forIndexPath:indexPath];
        [self reloadMyCourseViewCell:cell];
        normalCell = cell;
        return normalCell;
    };
...
- (void)reloadMyCourseViewCell:(MyCourseViewCell *)cell{
